...
This folder contains code to calculate rating of the doctors by applying sentimental analysis using TextBlob on reviews given by patients that we have collected in comments list during scrapping.
